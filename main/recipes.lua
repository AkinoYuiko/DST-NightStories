...
-- 暗影破碎者 --
local simage = "nightmare_spear.tex"
local satlas = GetInventoryItemAtlas(simage)
AddRecipe("shadowglash_builder", {Ingredient("nightmarefuel", 1)}, TECH.NONE, { atlas = satlas, image = simage, builder_tag = "ns_builder_dummy", no_deconstruction = true, sg_state = "domediumaction"})
...
-- 月光粉 --
AddRecipe("spice_moonglass", {Ingredient("purebrilliance", 3)}, TECH.FOODPROCESSING_ONE, {nounlock = true, numtogive = 2, nochar = true, builder_tag = "professionalchef", no_deconstruction = true})
