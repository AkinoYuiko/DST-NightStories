...
AddCharacterRecipe("civi_redgem",
    ...
    TECH.CELESTIAL_ONE,
    {nounlock = true, builder_tag = "ns_builder_civi", image = "redgem.tex", product = "redgem"},
    {"CRAFTING_STATION" }
)

-- 蓝宝石 --
AddCharacterRecipe("civi_bluegem",
...
AddCharacterRecipe("civi_darkamulet",
    ...
    TECH.CELESTIAL_ONE,
    {nounlock = true, builder_tag = "ns_builder_civi", image ="darkamulet.tex", product = "darkamulet"},
    {"CRAFTING_STATION", "MODS"}
)

AddRecipe2("darkamulet",
...
-- 光明护符 --
AddCharacterRecipe("civi_lightamulet",
    {Ingredient("moonrocknugget", 3), Ingredient("nightmarefuel", 3), Ingredient("lightgem", 1)},
    TECH.CELESTIAL_ONE,
    {nounlock = true, builder_tag = "ns_builder_civi", image = "lightamulet.tex", product ="lightamulet"},
    {"CRAFTING_STATION", "MODS"}
)

AddRecipe2("lightamulet",
    {Ingredient("moonrocknugget", 3), Ingredient("nightmarefuel", 3), Ingredient("lightgem", 1)},
    TECH.ANCIENT_TWO,
    {nounlock = true},
    {"MODS"}
...
-- 暗影破碎者 --
AddCharacterRecipe("nightmare_spear",
...
-- 收获的季节 --
AddCharacterRecipe("book_harvest",
...
-- 雨神的眷恋 --
AddCharacterRecipe("book_toggledownfall",
...
-- 黑洞法杖 --
AddCharacterRecipe("blackholestaff",
    {Ingredient("livinglog", 2), Ingredient("orangegem", 2), Ingredient("nightmarefuel", 4)},
    TECH.ANCIENT_FOUR,
    {nounclock = true, builder_tag = "ns_builder_dummy"},
    {"CRAFTING_STATION", "MODS"}
)

-- 仙人掌粉 --
AddRecipe2("spice_cactus",
    {Ingredient("cactus_meat", 2), Ingredient("cactus_flower", 1)},
    TECH.FOODPROCESSING_ONE,
    {nounlock = true, numtogive = 2, builder_tag = "professionalchef"},
    {"MODS"}
)

-- 便携衣柜 & 魔法礼装 --
AddRecipe2("portable_wardrobe_wrap",
...
AddRecipe2("portable_wardrobe_item",
