...
-- 黑宝石 --
AddRecipe("darkgem", {Ingredient("purplegem", 1), Ingredient("nightmarefuel", 4)}, TECH.NONE, {builder_tag = "ns_builder_civi", no_deconstruction = true}, {"REFINE", "MAGIC"})
SortAfter("darkgem", "purplegem", "REFINE")
SortAfter("darkgem", "purplegem", "MAGIC")

-- 白宝石 --
AddRecipe("lightgem", {Ingredient("purplegem", 1), Ingredient("nightmarefuel", 4)}, TECH.NONE, {builder_tag = "ns_builder_civi", no_deconstruction = true}, {"REFINE", "MAGIC"})
SortAfter("lightgem", "darkgem", "REFINE")
SortAfter("lightgem", "darkgem", "MAGIC")
...
AddRecipe("civi_darkmagatama", {Ingredient("darkgem", 1), Ingredient("nightmarefuel", 1)}, TECH.MAGIC_THREE, {nomods = true, builder_tag = "ns_builder_civi", image = "darkmagatama.tex", product = "darkmagatama"}, {"MAGIC"})
...
AddRecipe("civi_lightmagatama", {Ingredient("lightgem", 1), Ingredient("nightmarefuel", 1)}, TECH.MAGIC_THREE, {nomods = true, builder_tag = "ns_builder_civi", image = "lightmagatama.tex", product = "lightmagatama"}, {"MAGIC"})
SortAfter("civi_lightmagatama", "civi_darkmagatama", "MAGIC")
