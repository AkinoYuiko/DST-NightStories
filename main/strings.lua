...
local strings = {
    NAMES = 
    {
        ...
        NIGHTPACK_RED = "Red Night Backpack",
        NIGHTPACK_BLUE = "Blue Night Backpack",
        NIGHTPACK_PURPLE = "Purple Night Backpack",
        NIGHTPACK_YELLOW = "Yellow Night Backpack",
        NIGHTPACK_ORANGE = "Orange Night Backpack",
        NIGHTPACK_GREEN = "Green Night Backpack",
        NIGHTPACK_OPAL = "Opal Night Backpack",
        NIGHTPACK_DARK = "Dark Night Backpack",
        NIGHTPACK_LIGHT = "Light Night Backpack",
        NIGHTPACK_FUEL = "Fuel Night Backpack",
        DARKGEM = "Dark Gem",
        LIGHTGEM = "Light Gem",
